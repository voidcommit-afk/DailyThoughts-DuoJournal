            ...
            {audioNotes.length > 0 && (
                <div className="space-y-3">
                    {audioNotes.map((src, index) => (
                        <div
                            key={index}
                            className="flex items-center gap-4 p-4 bg-slate-900/40 border border-white/5 rounded-2xl group transition-all hover:border-primary/20"
                        >
                            ...
                            {!disabled && (
                                <button
                                    ...
                                    className="p-2 text-rose-400/50 hover:text-rose-400 hover:bg-rose-500/10 rounded-xl transition-all"
